  ...
  return (
    <div className="rounded-xl border border-amber-500/20 bg-amber-500/5 p-4 text-sm text-foreground/70">
      ...
      <ul className="space-y-1">
        <li>
          <span className="text-emerald-600 dark:text-emerald-300">Win</span> — {formatBeers(BEER_WIN)}
        </li>
        <li>
          <span className="text-red-600 dark:text-red-300">Lose</span> — {formatBeers(BEER_LOSE)}{" "}
